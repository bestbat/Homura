#!/bin/bash
# MESA [AMD] [INTEL]
#OPT=mesa_glthread=true
# NVIDIA
#OPT=__GL_THREADED_OPTIMIZATIONS=1
HEIGHT=15
WIDTH=40
CHOICE_HEIGHT=4
...
WINEPREFIX=/home/$USER/Games/Steam $OPT wine "/home/$USER/Games/Steam/drive_c/Program Files/Steam/Steam.exe" -no-cef-sandbox
            ;;
        2)
WINEPREFIX=/home/$USER/Games/Blizzard $OPT wine "/home/alexander/Games/Blizzard/drive_c/Program Files/Battle.net/Battle.net.exe"          
            ;;
        3)  
WINEPREFIX=/home/$USER/Games/Origin $OPT wine "/home/$USER/Games/Origin/drive_c/Program Files/Origin/Origin.exe"             
            ;;
        4)  
WINEPREFIX=/home/$USER/Games/Uplay $OPT wine "/home/$USER/Games/Uplay/drive_c/Program Files/Ubisoft/Ubisoft Game Launcher/Uplay.exe"            
            ;;
        5)
WINEPREFIX=/home/$USER/Programs/Teamspeak $OPT wine "/home/$USER/Programs/Teamspeak/TeamSpeak 3 Client/ts3client_win32.exe"
            ;;
        6)
WINEPREFIX="/home/$USER/Games/Clone Hero" $OPT wine "/home/$USER/Games/Clone Hero/clonehero-win32/Clone Hero.exe"
            ;;
        7)
WINEPREFIX="/home/$USER/Games/Drakensang Online/" $OPT wine "/home/$USER/Games/Drakensang Online/drive_c/Program Files/Drakensang Online/thinclient.exe"  
            ;;
        8)
env WINEPREFIX="/home/$USER/Games/Anarchy Online" $OPT wine C:\\windows\\command\\start.exe /Unix /home/$USER/Games/Anarchy\ Online/dosdevices/c:/ProgramData/Microsoft/Windows/Start\ Menu/Programs/Anarchy\ Online/Anarchy\ Online.lnk
            ;;
        9)
VERSION=25.4.0
WINEPREFIX=/home/$USER/Games/itch $OPT wine "/home/$USER/.wine/drive_c/users/$USER/Local Settings/Application Data/itch/app-$VERSION/itch.exe"
esac
            ;;
        3)
#!/bin/bash
