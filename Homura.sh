...
if [[ $INST == *"Steam"* ]]; then
echo $'\033]30;Homura 1.5 - Installation of Steam\007'
...
if [[ $INST == *"Origin"* ]]; then
echo $'\033]30;Homura 1.5 - Installation of Origin\007'
mkdir -p /home/$USER/.local/share/$NAME/Games/$INST
cd /home/$USER/.local/share/$NAME/Games/$INST
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
if [[ $INST == *"Uplay"* ]]; then
echo $'\033]30;Homura 1.5 - Installation of Uplay\007'
mkdir -p /home/$USER/.local/share/$NAME/Games/$INST
cd /home/$USER/.local/share/$NAME/Games/$INST
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
echo $'\033]30;Homura 1.5 - Installation of Teamspeak\007'
...
echo $'\033]30;Homura 1.5 - Installation of Clone Hero\007'
mkdir -p "/home/$USER/.local/share/$NAME/Games/$INST"
cd "/home/$USER/.local/share/$NAME/Games/$INST"
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
echo $'\033]30;Homura 1.5 - Installation of Drakensang Online\007'
mkdir -p "/home/$USER/.local/share/$NAME/Games/$INST"
cd "/home/$USER/.local/share/$NAME/Games/$INST"
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
echo $'\033]30;Homura 1.5 - Installation of Anarchy Online\007'
mkdir -p "/home/$USER/.local/share/$NAME/Games/$INST"
cd "/home/$USER/.local/share/$NAME/Games/$INST"
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
if [[ $INST == *"itch"* ]]; then
echo $'\033]30;Homura 1.5 - Installation of itch\007'
mkdir -p /home/$USER/.local/share/$NAME/Games/$INST
cd /home/$USER/.local/share/$NAME/Games/$INST
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
echo $'\033]30;Homura 1.5 - Installation of GOG Galaxy\007'
mkdir -p "/home/$USER/.local/share/$NAME/Games/$INST"
cd "/home/$USER/.local/share/$NAME/Games/$INST"
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
...
echo $'\033]30;Homura 1.5 - Installation of League of Legends\007'
mkdir -p "/home/$USER/.local/share/$NAME/Games/$INST"
cd "/home/$USER/.local/share/$NAME/Games/$INST"
echo -e "\e[40;38;5;82mDownloading $INST\e[30;48;5;82m\e[0m"
