...
Application | Works?
------------ | -------------
[Steam](https://store.steampowered.com/) | Runs out of the box, uses the minimal mode to use online features and the browser is disabled but things like buying games etc.. can be done with your native web browser ;)
