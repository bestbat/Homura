...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/the-homura-project/homura) [![Discord](https://img.shields.io/badge/chat-on%20discord-7289da.svg?logo=discord)](https://discord.gg/JBKcdNt) <img src="https://img.shields.io/discord/618845118060953600">
...
Application | Works?
------------ | -------------
[Steam](https://store.steampowered.com/) | Runs out of the box, uses the minimal mode to use online features and the browser is disabled but things like buying games etc.. can be done with your native web browser. Thanks to the FreeBSD user: drozdowsky.
